...
4. Read `.agent/agents.md` to remind yourself of the environment, cluster constraints, and your fundamental rules.
...
1. Because the next loop starts with a clean context, append your learnings (gotchas, newly established patterns, file locations) to `.agent/progress.txt` or `.agent/agents.md`.
2. Say exactly what the *next* agent needs to know.
