...
DOCKER_TAG=$DOCKER_REGISTRY_HOST/repository/docker-repo/my-site-back-end:$TAG_VERSION
DOCKER_TAG_LATEST=$DOCKER_REGISTRY_HOST/repository/docker-repo/my-site-back-end:latest
...
sed -i "s|image: .*|image: $DOCKER_TAG|" ./k8s/minikube/my-site-back-end.yaml
