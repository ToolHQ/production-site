...
export const queries: { name: string; description: string; query: string }[] = [
  {
    name: 'ABORT',
...
export const statementTypeCount: Map<string, number> = new Map();
export const statementTypeQueries: Map<string, unknown[]> = new Map();
