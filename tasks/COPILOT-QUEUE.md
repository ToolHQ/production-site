...
| [T-303](2026/Q2/T-303-SSDNodes-Dashboard-Kubecost-HTTPS.md)  | **SSDNodes — Kubernetes Dashboard + Kubecost HTTPS** (`k8s.ssdnodes.dnor.io` + `cost.ssdnodes.dnor.io`, cert-manager TLS) | 🔵 Medium   |
