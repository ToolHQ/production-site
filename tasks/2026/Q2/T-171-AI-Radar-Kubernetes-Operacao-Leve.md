...
- [x] CronJobs **`ai-radar-extract`** / **`ai-radar-score`** (manifests + schedules DECISIONS)
- [ ] CronJob **`ai-radar-digest`** (daily/weekly) — código **T-169** pronto; manifest K8s opcional pós-**T-191**
